...
export default async function SettingsPage() {
  ...
  const plcs: SettingsPlcRow[] = data.plcs.map(({ plc, token, latestReading }) => ({
    ...
    pumpCoilAddress: plc.pumpCoilAddress,
    pumpRegisterAddress: plc.pumpRegisterAddress,
    pumpRegisterOnValue: plc.pumpRegisterOnValue,
    pumpRegisterOffValue: plc.pumpRegisterOffValue,
