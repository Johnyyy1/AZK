  ...
  return (
    <main className="p-8 min-h-screen">
      ...
      <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.1 }} className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        {/* Main KPI */}
        <div className="md:col-span-2 bg-surface-container-lowest rounded-xl p-8 relative overflow-hidden group hover-glow cursor-default">
        ...
        {/* Temp KPI */}
        <div className="bg-surface-container-low rounded-xl p-6 flex flex-col justify-between hover-glow cursor-default">
          <div>
        ...
        {/* Usage KPI */}
        <div className="bg-surface-container-high rounded-xl p-6 flex flex-col justify-between hover-glow cursor-default">
          <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.2 }} className="lg:col-span-2 bg-surface-container-lowest rounded-xl p-8">
          <div className="flex justify-between items-start mb-12">
            ...
            <div className="flex bg-surface-container p-1 rounded-lg">
              <button className="px-3 py-1 text-xs font-bold bg-surface-container-lowest shadow-sm rounded-md">24H</button>
          ...
          <div className="h-64 relative flex items-end">
            ...
            <div className="absolute left-[40%] bottom-[130px] -translate-x-1/2 bg-surface-container-lowest shadow-sm border border-outline-variant/30 p-2 rounded-lg shadow-xl">
        ...
        {/* Zone Efficiency */}
        <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.3 }} className="bg-surface-container rounded-xl p-8 space-y-8 hover-glow">
      ...
      {/* Watering Logs */}
      <motion.div {...fadeUp} transition={{ duration: 0.5, delay: 0.4 }} className="bg-surface-container-lowest rounded-xl overflow-hidden">
                ...
                <tr key={i} className="hover:bg-surface-container-low/50 transition-colors">
                  ...
                  <td className="px-8 py-5">
                    <span className={`text-[10px] px-2 py-1 rounded-md font-bold ${
                      log.method === "Manual" ? "bg-tertiary-fixed/20 text-tertiary-fixed-dim" : "bg-surface-container-high text-on-surface-variant"
                    }`}>{log.method}</span>
                  </td>
                  <td className="px-8 py-5">
