      ...
      <main className="pt-24 overflow-x-hidden">
        ...
        <section className="relative px-8 py-20 lg:py-32 max-w-7xl mx-auto flex flex-col items-center">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-8xl font-black text-primary font-headline tracking-tighter leading-[1.1] mb-8">
              Precision watering for a{" "}
              <span className="text-secondary">greener</span> world.
            </h1>
            <p className="text-on-surface-variant text-lg lg:text-2xl max-w-2xl mb-12 leading-relaxed">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                href="/auth"
                className="technical-gradient text-on-primary px-10 py-5 rounded-2xl font-bold text-xl organic-glow active:scale-95 transition-all"
              >
                Get Started
              </Link>
              <Link
                href="/auth"
                className="bg-surface-container-highest text-primary px-10 py-5 rounded-2xl font-bold text-xl active:scale-95 transition-all"
              >
                Login
              </Link>
            </div>
          ...
          {/* Background blurs */}
          <div className="absolute -top-10 -left-10 w-96 h-96 bg-secondary-fixed-dim/20 rounded-full blur-[100px] -z-10" />
          ...
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <motion.div
                ...
                className="md:col-span-8 bg-surface-container-lowest p-8 rounded-[2rem] flex flex-col justify-between min-h-[320px]"
              >
                <div>
                ...
                <div className="flex gap-4 mt-8">
                  <span className="px-3 py-1 rounded-lg bg-surface-container text-[10px] font-bold text-primary uppercase">
                    Precision Flow
                  </span>
                  <span className="px-3 py-1 rounded-lg bg-surface-container text-[10px] font-bold text-primary uppercase">
                    Zone Control
              ...
              <motion.div
                ...
                className="md:col-span-4 bg-primary text-on-primary p-8 rounded-[2rem] flex flex-col justify-center items-center text-center"
              >
                <div className="w-16 h-16 rounded-full bg-secondary-fixed-dim/20 flex items-center justify-center mb-6">
                  <span
              ...
              <motion.div
                ...
                className="md:col-span-4 bg-tertiary-fixed-dim p-8 rounded-[2rem] flex flex-col justify-between"
              >
                <h4 className="text-2xl font-bold font-headline text-primary">
                  Remote control
                </h4>
                <div className="my-6 aspect-video bg-white/20 rounded-xl flex items-center justify-center">
              ...
              <motion.div
                ...
                className="md:col-span-8 technical-gradient text-on-primary p-8 rounded-[2rem] flex flex-col md:flex-row items-center gap-8 overflow-hidden"
              >
                ...
                <div className="w-48 h-48 flex-shrink-0 relative">
                  <div className="absolute inset-0 border-4 border-dashed border-secondary-fixed-dim/30 rounded-full" />
        ...
        <section className="py-24 px-8 overflow-hidden bg-white">
          <div className="max-w-7xl mx-auto">
            <motion.div {...fadeUp} className="text-center mb-20">
              <h2 className="text-4xl lg:text-5xl font-black font-headline text-primary mb-6">
                A Living Laboratory
              </h2>
              <p className="text-on-surface-variant max-w-2xl mx-auto">
                Our dashboard isn&apos;t just data. It&apos;s the pulse of your
                ecosystem. Visualized with precision engineering.
              </p>
            </motion.div>
            <motion.div
              {...fadeUp}
                ...
                <div className="col-span-12 md:col-span-10">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                    {[
                      ...
                      <div
                        key={stat.label}
                        className="bg-white p-6 rounded-2xl organic-glow"
                      >
          ...
          <div className="max-w-7xl mx-auto px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {[
                ...
                >
                  <div className="w-16 h-16 rounded-2xl bg-white flex items-center justify-center mb-8 organic-glow group-hover:scale-110 transition-transform">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-center gap-16">
              ...
              <motion.div
                ...
                className="lg:w-1/2"
              >
                <h2 className="text-4xl lg:text-5xl font-black font-headline text-primary mb-8 leading-tight">
                  Grow more with less.
                </h2>
        ...
        <section className="py-24 px-8">
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-4xl lg:text-6xl font-black font-headline text-on-primary mb-8">
              ...
              <div className="flex flex-wrap gap-4 justify-center">
                <Link
                  href="/auth"
                  className="bg-secondary text-on-secondary px-10 py-5 rounded-2xl font-black text-xl organic-glow hover:scale-105 active:scale-95 transition-all"
                >
                  Get Started Now
                </Link>
